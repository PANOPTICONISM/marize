  ...
  return (
    <main className={style.finalSummary}>
      <div className={style.shoppingBag}>
        ...
        <p>
          Check out the details of your purchase below, and remember your order
          can’t be changed after it has been shipped, but you’re always welcome
          in our store.
        </p>
        <h1>Order Summary</h1>
      ...
      <div className={style.finalMessage}>
        <p>
          ...
          purchase, and another with shipping confirmation when your item(s) are
          on the way! We hope you enjoy your new items.
        </p>
        <p>Thank you!</p>
